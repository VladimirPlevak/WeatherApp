...
class ThreeDaysWeatherForecastFragment(private val weatherForecastList: List<WeatherForecastModel>): Fragment(){
    ...
    companion object {
        fun newInstance(weatherForecastList: List<WeatherForecastModel>): ThreeDaysWeatherForecastFragment {
            val fragment = ThreeDaysWeatherForecastFragment(weatherForecastList)
            return fragment
        }
    }
}